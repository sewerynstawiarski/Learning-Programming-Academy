...
public class ChallengeSolutionAnswer {
...
//                System.out.println("relativePathNumber = " + relativePath);
                if (relativePath == 1) {
                    folderSizes.clear();
                }
...
//                throw exc;
            ...
            if (relativeLevel == 1) {
                ...
                parentMap.merge(DIR_CNT, folderCount + 1, (oldValue, newValue) -> oldValue += newValue);
