...
public class MoreTimeMain {
    public static void main(String[] args) {
        ...
        System.out.println("Your kid's birthdate, LA time = " + dob.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)));

        ZonedDateTime dobSydney = ZonedDateTime.ofInstant(dobInstant, ZoneId.of("Australia/Sydney"));
        System.out.println("Your kid's birthdate, Sydney Time = " +  dobSydney.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)));

        ZonedDateTime dobHere  = dobSydney.withZoneSameInstant(ZoneId.systemDefault());
        System.out.println("Your kid's birthdate, Here Time = " + dobHere.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)));
        ...
        LocalDateTime dob2 = dob.plusYears(2).plusMonths(2).plusDays(4).plusHours(7).plusMinutes(14).plusSeconds(37);

        System.out.println("Your 2nd kid's birthdate, Here Time = " + dob2.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)));

        Period timePas2 = Period.between(LocalDate.EPOCH, dob2.toLocalDate());
        System.out.println(timePas2);
