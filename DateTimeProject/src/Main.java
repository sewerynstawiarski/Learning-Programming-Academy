...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(May5.withMonth(4));
        ...
        System.out.println("This is leap year? " + today.isLeapYear());
        System.out.println("Is leap year? " + May5.minusYears(2) +  May5.minusYears(2).isLeapYear());
        ...
        System.out.println(May5.format(dtf));
