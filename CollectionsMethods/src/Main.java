...
public class Main {
    public static void main(String[] args) {
        ...
        Collections.addAll(cards, cardArray);
        Card.printDeck(cards, "CardCollection with Aces added", 2);

        Collections.copy(cards, kingsOfClubs);
        Card.printDeck(cards, "Card Collection with Kings copied", 2);
        // This one doesn't create copy of the list. It just copies elements from another List to this one

        cards = List.copyOf(kingsOfClubs);
        Card.printDeck(cards,"List Copy of Kings", 1);
        // here it is the copy, but it returns unmodifiable list
        ...
        deck.sort(sortingAlgorithm); // Collection must be sorted before you use binary search!
        ...
        System.out.println("Best Card = " + Collections.max(deck, sortingAlgorithm)); // It has to be Comparable or you need to send Comparator
        ...
        Card.printDeck(deck, "Sorted by Suit, Ranked", 4);
