...
//        URI timsSite = URI.create("https://learningprogramming.academy/courses/complete-java-masterclass");
        URI timsSite = URI.create("courses/complete-java-masterclass");
        print(timsSite);

        try {
            URI second = new URI("http://user:pw@store.com:5000/products/phones?os=android#samsung");
            print(second);
