...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("%-14s %-15s %-8s %s%n", policyPayout, policyPayout.unscaledValue(), policyPayout.scale(),
        ...
        System.out.printf("%-14s %-15s %-8s %s%n", checkAmount, checkAmount.unscaledValue(), checkAmount.scale(),
        ...
        System.out.printf("%-14s %-15s %-8s %s%n", totalCheckAmount, totalCheckAmount.unscaledValue(), totalCheckAmount.scale(),
