...
public class Student {
    ...
    private final lpa.student.StudentDemographics demographics;
    ...
    public Student(String country, int month, int year, int age, String gender,
        ...
        demographics = new lpa.student.StudentDemographics(country, month, year, age, gender,
                hasExperience);
        ...
        for (Course course : courses) {
            engagementMap.put(course.courseCode(),
                    new lpa.student.CourseEngagement(course.courseCode(), month, year,
                            "Enrollment"));
        }
    }
