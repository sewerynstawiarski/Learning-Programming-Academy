...
public class FinalChallengeSolution {
    public static void main(String[] args) {
        ...
        List<Student> students = Stream.generate(() -> Student.getRandomStudent(pymc, jmc, cgj))
        ...
        System.out.println(students.stream().mapToInt(s -> s.getEngagementMap().size())
                .summaryStatistics());
