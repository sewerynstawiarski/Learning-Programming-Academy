...
public class Main {
    public static void main(String[] args) {
        ...
        String prefix = "NATO";
       // String myString = "enclosing Method's myString"; variables used in lambdas must be final or effectively final
        ...
        var result3 = calculator((a ,b) -> a.toUpperCase() + " " + b.toUpperCase(), "Ralph", "Kaminari");
