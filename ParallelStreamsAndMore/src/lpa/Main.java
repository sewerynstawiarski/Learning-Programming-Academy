...
record  Person (String firstName, String lastName, int age) {
    private final static String[] firsts =
            {"Harry", "Hermiona", "Ron", "Ginny", "Hagrid", "Albus", "Severus", "Tom", "Godryk"};
    private final static String[] lasts =
            {"Hufelpuff", "Gryffindor", "Ravenclaw", "Slytherin"};
    private final static Random random = new Random();

    public Person() {
        this(firsts[random.nextInt(firsts.length)], lasts[random.nextInt(lasts.length)], random.nextInt(18,80));
    }
