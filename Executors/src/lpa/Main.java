...
//            }
    ...
    public static void cachedMain(String[] args) {
        ...
        try {
            ...
            try {
                System.out.println(redValue.get(50, TimeUnit.SECONDS));
                System.out.println(blueValue.get(50, TimeUnit.SECONDS));
                System.out.println(greenValue.get(50, TimeUnit.SECONDS));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
...
//            }
  ...
  if (isDone) {
      System.out.println("Blue finished, yellow is starting");
    ...
    private static void countDown() {
        ...
        try {
            ...
            //ignoring possible bad user input
        }
    ...
    private static int sum(int start, int end, int delta, String colorString) {
        ...
        try {
            ...
            //ignoring potential wrong color name input
        }
