...
//        NavigableSet<Contact> sorted = new TreeSet<>(phones);
        ...
        descendingSet.forEach(System.out::println);
        System.out.println("-".repeat(20));
        fullSet.forEach(System.out::println); // whatever you do to the descending set will be reflected in original one
        System.out.println("-".repeat(20));

        Contact marion = new Contact("Maid Marion");
//        var headSet = fullSet.headSet(marion); // exclusive by default
        var headSet = fullSet.headSet(marion, true);
        headSet.forEach(System.out::println);
        System.out.println("-".repeat(20));

//        var tailSet = fullSet.tailSet(marion); // inclusive by default
        var tailSet = fullSet.tailSet(marion, false);
        tailSet.forEach(System.out::println);
        System.out.println("-".repeat(20));

        Contact linus = new Contact("Linus Van Pelt");
//        var subset = fullSet.subSet(linus, marion); //first element will be included by deafault, last will not be included
